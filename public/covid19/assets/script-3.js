// Función asincrónica que solicita los datos de casos confirmados en
// Chile, usando un JWT como parámetro
// Se hace destructuring al objeto retornado para obtener el 
// la propiedad data que contiene el arreglo de datos
...
// Función asincrónica que solicita los datos de casos muertos en
// Chile, usando un JWT como parámetro
// Se hace destructuring al objeto retornado para obtener el 
// la propiedad data que contiene el arreglo de datos
...
// Función asincrónica que solicita los datos de casos recuperados en
// Chile, usando un JWT como parámetro
// Se hace destructuring al objeto retornado para obtener el 
// la propiedad data que contiene el arreglo de datos
...
// Función para generar el gráfico a partir de los datos retornados
// por las tres funciones anteriores
// El gráfico usa tres arreglos generados mediante los métodos
// forEach() y push() para que sean adecuados para usar como 
...
// Función IIFE para cargar el gráfico a llamando a las tres funciones
// de un principio pásandole como argumento el JWT guardado en 
// localStorage
